...
Το αρχείο αυτό περιγράφει την αναμενόμενη συμπεριφορά του εργαλείου **go-reloaded**.  
Κάθε test περιλαμβάνει **Input** και το αντίστοιχο **Expected Output**.

---

## A. Core Cases (από το θέμα)
...
## C. Big Paragraph (συνδυασμός κανόνων)
**Input**
