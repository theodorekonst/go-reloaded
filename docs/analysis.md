...
Το **go-reloaded** είναι ένα εργαλείο διόρθωσης κειμένου γραμμένο σε Go.  
...
- Σε γενικότερα πλαίσια, καταλαβαίνω ότι είναι η πιο εύκολη μέθοδος για να αρχίσει κάποιος.
